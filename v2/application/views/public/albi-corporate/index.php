<section style="background: url('{assets_url}/img/photogrid.jpg') center center repeat; background-size: cover;" class="relative-positioned">
	<!-- Carousel Start-->
			...
			<div class="homepage owl-carousel">
				<div class="item">
					<div class="row">
						<div class="col-md-5 text-right">
							<p><img src="{assets_url}/img/logo.png" alt="" class="ml-auto"></p>
							<h1>Multipurpose responsive theme</h1>
							<p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
						</div>
						<div class="col-md-7"><img src="{assets_url}/img/template-homepage.png" alt="" class="img-fluid"></div>
					</div>
				</div>
				<div class="item">
					<div class="row">
						<div class="col-md-7 text-center"><img src="{assets_url}/img/template-mac.png" alt="" class="img-fluid"></div>
						<div class="col-md-5">
				...
				<div class="item">
					<div class="row">
						...
						<div class="col-md-7"><img src="{assets_url}/img/template-easy-customize.png" alt="" class="img-fluid"></div>
					</div>
				</div>
				<div class="item">
					<div class="row">
						<div class="col-md-7"><img src="{assets_url}/img/template-easy-code.png" alt="" class="img-fluid"></div>
						<div class="col-md-5">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="row portfolio text-center color-white">
					<div class="col-md-4">
						<div class="box-image">
							<div class="image"><img src="{assets_url}/img/portfolio-1.jpg" alt="" class="img-fluid">
					...
					<div class="col-md-4">
						<div class="box-image">
							<div class="image"><img src="{assets_url}/img/portfolio-2.jpg" alt="" class="img-fluid">
								<div class="overlay d-flex align-items-center justify-content-center">
									<div class="content">
										<div class="name">
											<h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
					...
					<div class="col-md-4">
						<div class="box-image">
							<div class="image"><img src="{assets_url}/img/portfolio-3.jpg" alt="" class="img-fluid">
								<div class="overlay d-flex align-items-center justify-content-center">
									<div class="content">
										<div class="name">
											<h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<ul class="list-unstyled owl-carousel customers no-mb">
					<li class="item"><img src="{assets_url}/img/customer-1.png" alt="" class="img-fluid"></li>
					<li class="item"><img src="{assets_url}/img/customer-2.png" alt="" class="img-fluid"></li>
					<li class="item"><img src="{assets_url}/img/customer-3.png" alt="" class="img-fluid"></li>
					<li class="item"><img src="{assets_url}/img/customer-4.png" alt="" class="img-fluid"></li>
					<li class="item"><img src="{assets_url}/img/customer-5.png" alt="" class="img-fluid"></li>
					<li class="item"><img src="{assets_url}/img/customer-6.png" alt="" class="img-fluid"></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="home-blog-post">
						<div class="image"><img src="{assets_url}/img/portfolio-4.jpg" alt="..." class="img-fluid">
				...
				<div class="col-lg-3">
					<div class="home-blog-post">
						<div class="image"><img src="{assets_url}/img/portfolio-5.jpg" alt="..." class="img-fluid">
							<div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
						</div>
						<div class="text">
				...
				<div class="col-lg-3">
					<div class="home-blog-post">
						<div class="image"><img src="{assets_url}/img/portfolio-6.jpg" alt="..." class="img-fluid">
							<div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
						</div>
						<div class="text">
							<h4><a href="#">Fashion Now </a></h4>
