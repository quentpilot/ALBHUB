...
/**
 * Query_builder aims to build SQL query related to request
 * using CI_DB_query_builder or a custom query builder class
 */

require_once APPPATH . 'libraries/tool/orm/builder/query/IQuery_builder.php';

//class Query_builder extends CI_DB_query_builder implements IQuery_builder {
class Query_builder extends CI_DB_driver implements IQuery_builder {
