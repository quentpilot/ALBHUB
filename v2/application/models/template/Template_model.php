...
/**
* Template_model class would to get data to insert through related partial view called
*
* @date 2018-03-15
...
class Template_model extends MY_ORM_Model {
  ...
  */
  ...
  /**
  * render attribute is the current instance of Render library class
  */
