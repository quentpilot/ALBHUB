...
<html class="no-js">
  <head>
    ...
    <link rel="stylesheet" href="<?= site_url("$template/css/onepage-scroll.css") ?>">
    <!-- theme stylesheet-->
  ...
  <body>
    ...
    <script src="<?= site_url("$template/js/jquery.onepage-scroll.js") ?>"></script>
