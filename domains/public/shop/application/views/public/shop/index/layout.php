...
<head>
    ...
    <title>
        ALB Impression | Boutique en ligne
    </title>
    ...
    <!-- styles -->
    <link href="<?= site_url("$template/css/font-awesome.css") ?>" rel="stylesheet">
    <link href="<?= site_url("$template/css/bootstrap.min.css") ?>" rel="stylesheet">
    <link href="<?= site_url("$template/css/animate.min.css") ?>" rel="stylesheet">
    <link href="<?= site_url("$template/css/owl.carousel.css") ?>" rel="stylesheet">
    <link href="<?= site_url("$template/css/owl.theme.css") ?>" rel="stylesheet">
    ...
    <script src="<?= site_url("$template/js/respond.min.js") ?>"></script>
</head>
...
<body>
 ...
 _________________________________________________________ -->
    ...
    <!-- *** SCRIPTS TO INCLUDE ***
 _________________________________________________________ -->
    <script src="<?= site_url("$template/js/jquery-1.11.0.min.js") ?>"></script>
    <script src="<?= site_url("$template/js/bootstrap.min.js") ?>"></script>
    <script src="<?= site_url("$template/js/jquery.cookie.js") ?>"></script>
    <script src="<?= site_url("$template/js/waypoints.min.js") ?>"></script>
    <script src="<?= site_url("$template/js/modernizr.js") ?>"></script>
    <script src="<?= site_url("$template/js/bootstrap-hover-dropdown.js") ?>"></script>
